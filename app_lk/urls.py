...
from app_lk.views import CreateProductView, get_products_view, update_product_view, delete_product_view

urlpatterns = [
    path('', login_required(get_products_view), name='lk_read'),
    path('add_product', login_required(CreateProductView.as_view()), name='lk_create'),
